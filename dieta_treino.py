...
# Caminhos seguros baseados no local do script
base_dir = os.path.dirname(__file__)
input_path = os.path.join(base_dir, '..', 'data', 'Dieta_e_Treino.xlsx')
output_path = os.path.join(base_dir, '..', 'outputs', 'Dieta_e_Treino.xlsx')  # Mesmo nome
